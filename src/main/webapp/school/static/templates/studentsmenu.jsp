    ...
    <div class="insert-wrapper">
        ...
        <div class="bot-gap">
            <form method="POST" action="${pageContext.request.contextPath}/schoolapp/studentInsert">
                <input name="lastname" type="text" value="${requestScope.insertedStudent.lastname}" class="insert rounded" placeholder="Last name" autofocus/><br>
                <input name="firstname" type="text" value="${requestScope.insertedStudent.firstname}" class="insert rounded" placeholder="First name" autofocus/><br>
                <input name="gender" type="text" value="${requestScope.insertedStudent.gender}" class="insert rounded" placeholder="Gender" autofocus/><br>
                <input name="birthdate" type="text" value="${requestScope.insertedStudent.birthdate}" class="insert rounded" placeholder="Birthdate" autofocus/><br>
